...
type HiServiceClient interface {
	SayHi(ctx context.Context, opts ...grpc.CallOption) (HiService_SayHiClient, error)
}
...
func (c *hiServiceClient) SayHi(ctx context.Context, opts ...grpc.CallOption) (HiService_SayHiClient, error) {
...
func (x *hiServiceSayHiClient) Send(m *HiRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *hiServiceSayHiClient) CloseAndRecv() (*HiResponse, error) {
...
type HiServiceServer interface {
	SayHi(HiService_SayHiServer) error
...
func (UnimplementedHiServiceServer) SayHi(HiService_SayHiServer) error {
...
func _HiService_SayHi_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HiServiceServer).SayHi(&hiServiceSayHiServer{stream})
}
...
func (x *hiServiceSayHiServer) SendAndClose(m *HiResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *hiServiceSayHiServer) Recv() (*HiRequest, error) {
	m := new(HiRequest)
